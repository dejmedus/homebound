    ...
    <div className="mt-5 md:col-span-2 md:mt-0">
      <Form method="post">
        <div className="shadow sm:overflow-hidden sm:rounded-md">
          ...
          <h3 className="block text-md font-medium text-black underline bold" >Private</h3>
            ...
            <h3 className="block text-md font-medium text-black underline bold">Public</h3>
            <div className="grid grid-cols-3 gap-6">
              <div className="col-span-3 sm:col-span-2">
            ...
            <div>
              <label htmlFor="about" className="block text-sm font-medium text-stone-700">
                About
              </label>
            ...
            <div>
              ...
              <div className="mt-1 flex items-center">
                ...
                <button
                  type="button"
                  className="ml-5 rounded-md border border-stone-300 bg-white py-2 px-3 text-sm font-medium leading-4 text-stone-700 shadow-sm hover:bg-stone-50"
                >
                  Change
                </button>
              </div>
          ...
          <div className="bg-stone-50 px-4 py-3 text-right sm:px-6">
            <button
              type="submit"
